...
public class OrganizationCommunicationService {
    ...
    public OrganizationCommunicationSettingsDto updateSettings(Organization organization, UpdateOrganizationCommunicationSettingsRequest request) {
        ...
        settings.setWhatsappConfigJson(request.whatsappConfigJson());
    ...
    private OrganizationCommunicationSettingsDto toDto(OrganizationCommunicationSettings s) {
        return new OrganizationCommunicationSettingsDto(s.isEmailEnabled(), s.getEmailProvider(), s.getEmailConfigJson(),
                s.isSmsEnabled(), s.getSmsProvider(), s.getSmsConfigJson(),
                s.isWhatsappEnabled(), s.getWhatsappProvider(), s.getWhatsappConfigJson(), s.isInAppEnabled());
    }
}
